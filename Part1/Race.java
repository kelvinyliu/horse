...
public class Race
{
    ...
    public void startRace()
    {
        ...
        // for now, as all 3 lanes require horses
        if (lane1Horse == null || lane2Horse == null || lane3Horse == null) {
            System.out.println("Not enough horses in the race!");
            return;
        }
        ...
        // manages if multiple horses pass the finish line at the same time
        if (winningHorses.size() == 1) {
            System.out.println("Horse " + winningHorses.getFirst().getName() + " has won!");
        } else if (winningHorses.size() > 1) {
            // multiple winners, use random number generator to select who should win.
            Random rand = new Random();
            Horse actualWinner = winningHorses.get(rand.nextInt(winningHorses.size()));

            System.out.println("After a close call, it has been determined that horse " + actualWinner.getName() + " has won!");
        }
    }
